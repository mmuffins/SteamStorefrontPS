...
Update-ModuleManifest -Path $modulePath -Author $moduleOwner -Copyright $moduleCopyright -Description $moduleDescription -ModuleVersion $moduleVersion -Guid $moduleId -RootModule $targetPath
